...
#ifndef drf_CAUSALFOURIERSPLITTINGRULEFACTORY_H
#define drf_CAUSALFOURIERSPLITTINGRULEFACTORY_H
 ...
 */
class CausalFourierSplittingRuleFactory final: public SplittingRuleFactory {
public:
  CausalFourierSplittingRuleFactory() = default;
  std::unique_ptr<SplittingRule> create(const Data& data,
                                        const TreeOptions& options) const;
private:
  DISALLOW_COPY_AND_ASSIGN(CausalFourierSplittingRuleFactory);
};

} // namespace drf

#endif //drf_CAUSALFOURIERSPLITTINGRULEFACTORY_H
