...
#include "splitting/CausalFourierSplittingRule.h"

namespace drf {

std::unique_ptr<SplittingRule> CausalFourierSplittingRuleFactory::create(const Data& data,
                                                                      const TreeOptions& options) const {
  return std::unique_ptr<SplittingRule>(new CausalFourierSplittingRule(
