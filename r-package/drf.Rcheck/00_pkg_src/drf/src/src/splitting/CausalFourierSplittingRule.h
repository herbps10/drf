...
#ifndef drf_CAUSALFOURIERSPLITTINGRULE_H
#define drf_CAUSALFOURIERSPLITTINGRULE_H
...
#include "tree/Tree.h"
 ...
 class CausalFourierSplittingRule final: public SplittingRule {
 public:
   CausalFourierSplittingRule(size_t max_num_unique_values,
                        double alpha,
 ...
 private:
   ...
   DISALLOW_COPY_AND_ASSIGN(CausalFourierSplittingRule);
 };

 } // namespace drf

#endif //drf_CAUSALFOURIERSPLITTINGRULE_H
