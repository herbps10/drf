...
Eigen::SparseMatrix<double> compute_causal_weights(Rcpp::List forest_object, Rcpp::NumericMatrix train_matrix, Eigen::SparseMatrix<double> sparse_train_matrix, Rcpp::NumericMatrix test_matrix, Eigen::SparseMatrix<double> sparse_test_matrix, size_t treatment_index, unsigned int num_threads);
RcppExport SEXP _drf_compute_causal_weights(SEXP forest_objectSEXP, SEXP train_matrixSEXP, SEXP sparse_train_matrixSEXP, SEXP test_matrixSEXP, SEXP sparse_test_matrixSEXP, SEXP treatment_indexSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type forest_object(forest_objectSEXP);
    ...
    Rcpp::traits::input_parameter< unsigned int >::type num_threads(num_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_causal_weights(forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, treatment_index, num_threads));
    return rcpp_result_gen;
END_RCPP
}
// compute_causal_weights_oob
Eigen::SparseMatrix<double> compute_causal_weights_oob(Rcpp::List forest_object, Rcpp::NumericMatrix test_matrix, Eigen::SparseMatrix<double> sparse_test_matrix, size_t treatment_index, unsigned int num_threads);
RcppExport SEXP _drf_compute_causal_weights_oob(SEXP forest_objectSEXP, SEXP test_matrixSEXP, SEXP sparse_test_matrixSEXP, SEXP treatment_indexSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type forest_object(forest_objectSEXP);
    ...
    Rcpp::traits::input_parameter< size_t >::type treatment_index(treatment_indexSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type num_threads(num_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_causal_weights_oob(forest_object, test_matrix, sparse_test_matrix, treatment_index, num_threads));
    return rcpp_result_gen;
END_RCPP
}
// compute_causal_bootstrap_weights
std::vector<Eigen::SparseMatrix<double>> compute_causal_bootstrap_weights(Rcpp::List forest_object, Rcpp::NumericMatrix train_matrix, Eigen::SparseMatrix<double> sparse_train_matrix, Rcpp::NumericMatrix test_matrix, Eigen::SparseMatrix<double> sparse_test_matrix, size_t treatment_index, size_t ci_group_size, unsigned int num_threads);
RcppExport SEXP _drf_compute_causal_bootstrap_weights(SEXP forest_objectSEXP, SEXP train_matrixSEXP, SEXP sparse_train_matrixSEXP, SEXP test_matrixSEXP, SEXP sparse_test_matrixSEXP, SEXP treatment_indexSEXP, SEXP ci_group_sizeSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type forest_object(forest_objectSEXP);
    ...
    Rcpp::traits::input_parameter< unsigned int >::type num_threads(num_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_causal_bootstrap_weights(forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, treatment_index, ci_group_size, num_threads));
    return rcpp_result_gen;
END_RCPP
}
// compute_causal_bootstrap_weights_oob
std::vector<Eigen::SparseMatrix<double>> compute_causal_bootstrap_weights_oob(Rcpp::List forest_object, Rcpp::NumericMatrix test_matrix, Eigen::SparseMatrix<double> sparse_test_matrix, size_t treatment_index, size_t ci_group_size, unsigned int num_threads);
RcppExport SEXP _drf_compute_causal_bootstrap_weights_oob(SEXP forest_objectSEXP, SEXP test_matrixSEXP, SEXP sparse_test_matrixSEXP, SEXP treatment_indexSEXP, SEXP ci_group_sizeSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type forest_object(forest_objectSEXP);
    ...
    Rcpp::traits::input_parameter< size_t >::type ci_group_size(ci_group_sizeSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type num_threads(num_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_causal_bootstrap_weights_oob(forest_object, test_matrix, sparse_test_matrix, treatment_index, ci_group_size, num_threads));
    return rcpp_result_gen;
END_RCPP
}
// merge
...
// compute_witness
Eigen::MatrixXd compute_witness(Rcpp::List forest_object, Rcpp::NumericMatrix train_matrix, Eigen::SparseMatrix<double> sparse_train_matrix, Rcpp::NumericMatrix test_matrix, Eigen::SparseMatrix<double> sparse_test_matrix, Eigen::MatrixXd Ky, size_t ci_group_size, size_t treatment_index, double alpha, unsigned int num_threads);
RcppExport SEXP _drf_compute_witness(SEXP forest_objectSEXP, SEXP train_matrixSEXP, SEXP sparse_train_matrixSEXP, SEXP test_matrixSEXP, SEXP sparse_test_matrixSEXP, SEXP KySEXP, SEXP ci_group_sizeSEXP, SEXP treatment_indexSEXP, SEXP alphaSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type forest_object(forest_objectSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type test_matrix(test_matrixSEXP);
    Rcpp::traits::input_parameter< Eigen::SparseMatrix<double> >::type sparse_test_matrix(sparse_test_matrixSEXP);
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type Ky(KySEXP);
    Rcpp::traits::input_parameter< size_t >::type ci_group_size(ci_group_sizeSEXP);
    Rcpp::traits::input_parameter< size_t >::type treatment_index(treatment_indexSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type num_threads(num_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_witness(forest_object, train_matrix, sparse_train_matrix, test_matrix, sparse_test_matrix, Ky, ci_group_size, treatment_index, alpha, num_threads));
    return rcpp_result_gen;
END_RCPP
}
// gini_train
...
Rcpp::List causal_fourier_train(Rcpp::NumericMatrix train_matrix, Eigen::SparseMatrix<double> sparse_train_matrix, std::vector<size_t> outcome_index, size_t treatment_index, size_t sample_weight_index, bool use_sample_weights, unsigned int mtry, unsigned int num_trees, unsigned int min_node_size, double sample_fraction, bool honesty, double honesty_fraction, bool honesty_prune_leaves, size_t ci_group_size, double alpha, double imbalance_penalty, std::vector<size_t> clusters, unsigned int samples_per_cluster, bool compute_oob_predictions, unsigned int num_threads, unsigned int seed, size_t num_features, double bandwidth, unsigned int node_scaling, size_t causal_effect_splits);
RcppExport SEXP _drf_causal_fourier_train(SEXP train_matrixSEXP, SEXP sparse_train_matrixSEXP, SEXP outcome_indexSEXP, SEXP treatment_indexSEXP, SEXP sample_weight_indexSEXP, SEXP use_sample_weightsSEXP, SEXP mtrySEXP, SEXP num_treesSEXP, SEXP min_node_sizeSEXP, SEXP sample_fractionSEXP, SEXP honestySEXP, SEXP honesty_fractionSEXP, SEXP honesty_prune_leavesSEXP, SEXP ci_group_sizeSEXP, SEXP alphaSEXP, SEXP imbalance_penaltySEXP, SEXP clustersSEXP, SEXP samples_per_clusterSEXP, SEXP compute_oob_predictionsSEXP, SEXP num_threadsSEXP, SEXP seedSEXP, SEXP num_featuresSEXP, SEXP bandwidthSEXP, SEXP node_scalingSEXP, SEXP causal_effect_splitsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type train_matrix(train_matrixSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type bandwidth(bandwidthSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type node_scaling(node_scalingSEXP);
    Rcpp::traits::input_parameter< size_t >::type causal_effect_splits(causal_effect_splitsSEXP);
    rcpp_result_gen = Rcpp::wrap(causal_fourier_train(train_matrix, sparse_train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed, num_features, bandwidth, node_scaling, causal_effect_splits));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_drf_compute_causal_weights", (DL_FUNC) &_drf_compute_causal_weights, 7},
    {"_drf_compute_causal_weights_oob", (DL_FUNC) &_drf_compute_causal_weights_oob, 5},
    {"_drf_compute_causal_bootstrap_weights", (DL_FUNC) &_drf_compute_causal_bootstrap_weights, 8},
    {"_drf_compute_causal_bootstrap_weights_oob", (DL_FUNC) &_drf_compute_causal_bootstrap_weights_oob, 6},
    {"_drf_merge", (DL_FUNC) &_drf_merge, 1},
    {"_drf_compute_witness", (DL_FUNC) &_drf_compute_witness, 10},
    ...
    {"_drf_causal_fourier_train", (DL_FUNC) &_drf_causal_fourier_train, 25},
    {NULL, NULL, 0}
};
