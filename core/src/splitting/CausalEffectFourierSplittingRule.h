...
#ifndef drf_CAUSALEFFECTFOURIERSPLITTINGRULE_H
#define drf_CAUSALEFFECTFOURIERSPLITTINGRULE_H
...
#include "tree/Tree.h"
 ...
 class CausalEffectFourierSplittingRule final: public SplittingRule {
 public:
   CausalEffectFourierSplittingRule(size_t max_num_unique_values,
                        double alpha,
   ...
   ~CausalEffectFourierSplittingRule();
 ...
 private:
   ...
   DISALLOW_COPY_AND_ASSIGN(CausalEffectFourierSplittingRule);
 };

 } // namespace drf

#endif //drf_CAUSALEFFECTFOURIERSPLITTINGRULE_H
