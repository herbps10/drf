...
#ifndef drf_CAUSALEFFECTFOURIERSPLITTINGRULEFACTORY_H
#define drf_CAUSALEFFECTFOURIERSPLITTINGRULEFACTORY_H
 ...
 */
class CausalEffectFourierSplittingRuleFactory final: public SplittingRuleFactory {
public:
  CausalEffectFourierSplittingRuleFactory() = default;
  std::unique_ptr<SplittingRule> create(const Data& data,
                                        const TreeOptions& options) const;
private:
  DISALLOW_COPY_AND_ASSIGN(CausalEffectFourierSplittingRuleFactory);
};

} // namespace drf

#endif //drf_CAUSALEFFECTFOURIERSPLITTINGRULEFACTORY_H
